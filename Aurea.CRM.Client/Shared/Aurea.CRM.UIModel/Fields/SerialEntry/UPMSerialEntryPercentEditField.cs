// --------------------------------------------------------------------------------------------------------------------
// <copyright file="UPMSerialEntryPercentEditField.cs" company="Aurea Software Gmbh">
...
// </author>
// <summary>
//   The UPMSerialEntryPercentEditField.
// </summary>
// --------------------------------------------------------------------------------------------------------------------
...
namespace Aurea.CRM.UIModel.Fields.SerialEntry
{
    ...
    /// <summary>
    /// UPMSerialEntryPercentEditField
    /// </summary>
    /// <seealso cref="Aurea.CRM.UIModel.Fields.Edit.UPMPercentEditField" />
    /// <seealso cref="Aurea.CRM.UIModel.Fields.SerialEntry.UPMSerialEntryEditField" />
    public class UPMSerialEntryPercentEditField : UPMPercentEditField, UPMSerialEntryEditField
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UPMSerialEntryPercentEditField"/> class.
        /// </summary>
        /// <param name="identifier">The identifier.</param>
        /// <param name="column">The column.</param>
        /// <param name="position">The position.</param>
        public UPMSerialEntryPercentEditField(IIdentifier identifier, UPSEColumn column, UPMSEPosition position)
            : base(identifier)
        {
