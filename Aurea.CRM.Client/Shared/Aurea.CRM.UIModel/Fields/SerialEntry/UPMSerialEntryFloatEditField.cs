// --------------------------------------------------------------------------------------------------------------------
// <copyright file="UPMSerialEntryFloatEditField.cs" company="Aurea Software Gmbh">
...
// </author>
// <summary>
//   The UPMSerialEntryFloatEditField.
// </summary>
// --------------------------------------------------------------------------------------------------------------------
...
namespace Aurea.CRM.UIModel.Fields.SerialEntry
{
    ...
    /// <summary>
    /// UPMSerialEntryFloatEditField
    /// </summary>
    /// <seealso cref="Aurea.CRM.UIModel.Fields.Edit.UPMFloatEditField" />
    ...
    public class UPMSerialEntryFloatEditField : UPMFloatEditField, UPMSerialEntryEditField, UPMSerialEntryStepableSize
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UPMSerialEntryFloatEditField"/> class.
        /// </summary>
        /// <param name="identifier">The identifier.</param>
        /// <param name="column">The column.</param>
        /// <param name="position">The position.</param>
        public UPMSerialEntryFloatEditField(IIdentifier identifier, UPSEColumn column, UPMSEPosition position)
          : base(identifier)
        {
            this.SerialEntryColumn = column;
            this.SerialEntryPosition = position;
            this.SupportsDecimals = true;
        }
