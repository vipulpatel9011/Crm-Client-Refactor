// <copyright file="AnalysisFunctionSumCat.cs" company="Aurea Software Gmbh">
...
namespace Aurea.CRM.Core.Analysis.Value.AnalysisFunction
{
    ...
    /// <summary>
    /// Implementation of analysis function sum cat
    /// </summary>
    public class AnalysisFunctionSumCat : AnalysisFunction
    {
        /// <inheritdoc/>
        public override string Name => "SUMCAT";
