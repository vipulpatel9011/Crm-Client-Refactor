// <copyright file="AnalysisFunctionMax.cs" company="Aurea Software Gmbh">
...
namespace Aurea.CRM.Core.Analysis.Value.AnalysisFunction
{
    ...
    /// <summary>
    /// Implementation of analysis function max
    /// </summary>
    public class AnalysisFunctionMax : AnalysisFunction
    {
        /// <inheritdoc/>
